...
-- -----------------------------------------------------
CREATE
SCHEMA IF NOT EXISTS `qiandao` DEFAULT CHARACTER SET utf8 ;
USE `qiandao` ;
...
(
    ...
    `type`          TINYINT(1)    NOT NULL DEFAULT 0 COMMIT 'tpl 类型, 0-har， 1-python',
  ...
  INDEX `ix_userid` (`userid`)) ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8;
...
(
  ...
  INDEX `ix_tplid` (`tplid` ASC)) ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8
...
(
  ...
  INDEX `ix_status` (`status` ASC)) ENGINE = MyISAM;
